...
class NetentionServer {
    constructor() {
        ...
        this.noteStepHandler = new NoteStepHandler(this.state); // Instantiate NoteStepHandler
        this.noteRunner = new NoteRunner(this.state, this.noteStepHandler); // Pass NoteStepHandler to NoteRunner
