...
:
    "system",
        +desc
:
    "Run initial system diagnostics to check core components."
    +
}
,
+status
...
:
    '13',
        +tool
:
    'diagnose_note', // Run diagnose_note tool on seed-0 itself
        +input
:
    {
        'seed-0'
    ...
    :
        {
            'Note', definition
        :
            'A fundamental unit of knowledge and action in Netention.'
        }
    ,
        [],
            status
    ...
    :
        {
            'Agent',
                definition
        :
            'The intelligent entity associated with a Note, responsible for planning and execution.'
        }
    ,
        [],
            status
    ...
    :
        {
            'Plan',
                definition
        :
            'A graph-based representation of steps to achieve a Note\'s goal.'
        }
    ,
        [],
            status
    ...
    :
        {
            'Tool',
                definition
        :
            'External functions or modules that Agents use to interact with the world.'
        }
    ,
        [],
            status
...
,
    ...
    ,
        ['5', '6', '7', '8'], // Depend on define_concept steps
            status
    :
        'pending'
    }
        ...
        {
            {
                'hello_world',
                    description
            :
                'A simple tool that returns "Hello, world!" and takes a name as input',
                    code
            :
                'async function invoke(input) { return `Hello, ${input.name}!`; }',
                    schemaDef
            :
...
,
    {
        '11',
            tool
    :
        'hello_world', // Use the newly implemented tool
            input
    :
        {
            'Netention'
...
,
...
},
    {
        'demo-plan-1',
            title
    :
        'Demo Plan: Summarize and Generate Code',
            content
    :
        'Demonstrates a simple plan to summarize text and generate code.',
            status
    :
        'pending',
            priority
